...
class Profile(models.Model):
    ...
    coursesToTake = models.ManyToManyField(HomeCourse,blank=True)
    saved_courses = models.ManyToManyField(AbroadCourse,blank=True)
    saved_course_matches = models.ManyToManyField(CourseMatch,blank=True)
